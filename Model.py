...
def main():
    ...
    final_params, cost_in_per_batch = com_F.batchGradientDescent(inputData=training_input_data,labelData= training_label_data, parameters= parameters,  num_iteration= 1000, batch_size=128,no_of_samples=no_of_samples)
